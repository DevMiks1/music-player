...
const songs = [
  {
    ...
    artist: "Taylor Swift",
    url: "./X2Download.app - All Too Well (10 Minute Version) (Taylor's Version) (From The Vault) (Lyric Video) (320 kbps).mp3"
  },
  {
    title: "Speak Now (Taylor's Version)",
    artist: "Taylor Swift",
    url: "./X2Download.app - Taylor Swift - Speak Now (Taylor's Version) (Lyric Video) (128 kbps).mp3",
  }
];
...
async function fetchData() {
  ...
  const options = {
    method: "GET",
    headers: {
      "X-RapidAPI-Key": "b1f13b7b62msh243b12ba4652072p14427ajsn821f86ca9a7d",
